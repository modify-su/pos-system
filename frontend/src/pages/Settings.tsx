...
export default function Settings() {
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-6">
      ...
      {/* ========================================================================= */}
      {/* 📌 [จุดปรับแต่งและขยายแถบแท็บเมนูการตั้งค่า: Settings Tabs Navigation Bar]  */}
      {/* ปรับแต่งความกว้างและขนาดแท็บ:                                              */}
      {/*   - ระยะห่างระหว่างแท็บ: 'space-x-2 md:space-x-4' (ปรับเป็น 'gap-3' หรือ 'gap-4') */}
      {/*   - ขนาดปุ่มแท็บ: 'pb-3 px-4 text-sm' (ปรับเป็น 'py-3 px-6 text-base' เพื่อขยายใหญ่) */}
      {/*   - หากต้องการให้แท็บขยายกว้างเท่ากันเต็มแถบ: ใส่ 'flex-1 justify-center' ในปุ่ม */}
      {/* ========================================================================= */}
      {/* Tabs Navigation */}
