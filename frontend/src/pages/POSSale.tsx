  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      <div className="flex-1 flex flex-col p-4 gap-3 overflow-hidden bg-slate-50/70">
        ...
        {/* ========================================================================= */}
        {/* 📌 [จุดปรับแต่งและขยายแถบแท็บหมวดหมู่สินค้าหน้าร้าน: POS Category Tabs Bar]   */}
        {/* ปรับขนาดปุ่มแท็บหมวดหมู่:                                                   */}
        {/*   - ขนาดปุ่ม: 'px-3.5 py-1.5 text-xs' (ปรับเป็น 'px-5 py-2.5 text-sm' เพื่อให้ใหญ่ขึ้น) */}
        {/*   - ระยะห่าง: 'gap-2' (ปรับเป็น 'gap-3' ได้)                                 */}
        {/* ========================================================================= */}
        {/* Category Tabs */}
