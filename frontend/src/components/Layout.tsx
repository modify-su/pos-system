...
export default function Layout() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen overflow-hidden bg-slate-100 relative">
      ...
      {/* ================================================================================= */}
      {/* 📌 [จุดปรับแต่งและขยายความกว้างแถบเมนูบาร์ด้านข้าง: Desktop Sidebar Width]         */}
      {/* ปรับเปลี่ยนความกว้างของแถบเมนูด้านซ้ายนี้ได้ที่คลาส 'w-72' (288px)                 */}
      {/* ขนาดความกว้างที่แนะนำ (Tailwind Width):                                           */}
      {/*   - 'w-60'  = 240px  (แคบกะทัดรัด แต่อาจตัดทอนชื่อร้านยาว)                        */}
      {/*   - 'w-64'  = 256px  (ขนาดมาตรฐานปานกลาง)                                        */}
      {/*   - 'w-72'  = 288px  (★ ค่าปัจจุบัน แนะนำ: กว้างกำลังสวย โลโก้และชื่อร้านเด่นชัด)  */}
      {/*   - 'w-80'  = 320px  (กว้างพิเศษ กว้างเต็มตา เหมาะสำหรับจอใหญ่ Wide)              */}
      {/*   - 'w-[300px]' หรือกำหนดเป็นพิกเซลตรงๆ ได้ตามชอบ เช่น 'w-[280px]'                */}
      {/* ================================================================================= */}
      <aside className="hidden md:flex w-72 flex-shrink-0 bg-slate-900 text-slate-300 flex-col">
        {/* Logo */}
